package book_review.thinkDataStructures.ch2;
...
public class MyArrayList<T> implements List<T> {
    ...
    /**
     * TODO: FILL THIS IN!
     * check array size, if current size is equal or bigger than array.length
     * make bigger array and do copy
     */
    @Override
    public boolean add(T element) {
        if (size >= array.length) {
            ...
            array = bigger; // copy reference pointer
        }
        array[size] = element;
        size++;
        return true;
